...
def generate_test_suite_v2():
    ...
    tests = list(map(lambda x: x[:-7], filter(lambda x: x.endswith(".brewin"), listdir("./v2/tests"))))
    fails = list(map(lambda x: x[:-7], filter(lambda x: x.endswith(".brewin"), listdir("./v2/fails"))))
